...
from strategy_v3 import CoreOptimizedStrategies
...
def generate_test_recommendations():
    ...
    output_path = '../test_output/今日推荐_v3.0_2026-02-24.csv'
    ...
    report_path = '../test_output/今日推荐_v3.0_2026-02-24.md'
