...
**2026-02-27**
- **新增核心技能**: 将 qmd、memory-hygiene、prompt-injection-guard 三个技能正式添加到核心技能列表
  - **qmd**: 本地语义搜索引擎 (节省 90% Token)
  - **memory-hygiene**: 自动内存清理 (节省 30-40% Token)  
  - **prompt-injection-guard**: 安全防护 + 分层加载 (节省 70% Token)
- **核心技能总数**: 从 9 个增加到 12 个
- **长期记忆更新**: MEMORY.md 和桌面备份文件同步更新
...
- **Daily Profile Backup**: 每日凌晨 03:00 自动备份关键文件
  ...
  - 备份位置: 
    - GitHub 仓库: `blastai666/openclaw-kimi`
    - 本地桌面: `~/Desktop/openclaw-kimi/`
  - 提交信息格式: "Daily backup: YYYY-MM-DD"
  - **重要路径**: 桌面备份文件夹路径为 `~/Desktop/openclaw-kimi/`

- **News Report Backup**: 全球新闻日报和A股金融日报自动备份到桌面
  - 备份位置: `~/Desktop/openclaw-kimi/`
  - 文件命名: `news_report_YYYYMMDD.md`, `news_report_international_YYYYMMDD.md`, `个股筛选_YYYY-MM-DD.md`
  - 备份触发: 手动请求或自动化任务完成时
